...
-   Lead_score_case_study.ipynb – Python coding file showing analysis.
-   Assignment subjective questions.pdf – Few subjective questions answered.
-   Lead_Score_study.pdf – Final presentation
-   Leads.csv – Dataset file
-   Leads_Dictionary.xlsx – Data Dictionary
